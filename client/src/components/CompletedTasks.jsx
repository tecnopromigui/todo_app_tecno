...
import CardsCompleted from './CardsCompleted';
...
import styles from '../assets/styles/components/CompletedTasks.module.css';
const CompletedTasks = () => {
	...
	const tasksCompleted = useSelector((state) => state.completedTasks);
			...
			<main className={styles.content}>
				<div className={styles.searchTask}>
					<input
						...
						id=""
					/>
					<button className={styles.searchButtonCompleted}>
						<span>
							<svg
								viewBox="0 0 24 24"
								height="24"
				...
				<hr />
				<div>
					<div className={styles.contentCompletedTasks}>
